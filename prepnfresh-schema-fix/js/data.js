/* ==========================================================================
   ...
   When wiring up WorldPay (or another gateway) later: this file maps directly onto a
...
(function (window) {
  ...
  var PACKAGES = [
    { id: "try-it", name: "Try a Few", perMealPrice: 5.49, minMeals: 1, maxMeals: 4, schedule: "single", variable: true,
      tagline: "From just one meal \u2014 try before you commit",
      features: ["Choose 1 to 4 meals, all delivered on the same day", "Choose Tuesday or Friday delivery", "Full macro & allergen labelling", "No artificial additives or E-numbers, ever"] },
  ...
  PACKAGES.forEach(function (p) { if (!p.variable) p.perMeal = p.price / (p.meals * (p.weeks || 1)); else p.perMeal = p.perMealPrice; });

  var BUSINESS = {
    name: "Prep 'N' Fresh",
    whatsapp: "447930691588",
    email: "prepnfreshuk@gmail.com",
    phone: "07930 691588",
